\hypertarget{fisica_8c}{\section{src/fisica.c File Reference}
...
Include dependency graph for fisica.\-c\-:
...
Esta é a biblioteca de funções que lidam com a física do Red Knife Engine. \begin{DoxyAuthor}{Author}
